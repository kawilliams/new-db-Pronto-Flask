...
/*function hideFull(seats) {
	var seatsLeftClasses = document.getElementsByClassName('seats-left');
	seatsLeftClasses.style.display = 'none';
	var resultSpan = String(parseInt(document.getElementById("count").innerHTML) - seatsLeftClasses.length);
...
function countResults(chosen_year, tableId) {
	...
	var numResults = document.querySelectorAll("#results .acc-results").length;
