...
@app.route("/")
def home():	
	return render_template("search1.html", semesters=ALL_SEMESTERS)
...
def process_semester():
	...
	if request.method == "POST":
		...
		return render_template("search2.html", semesters=ALL_SEMESTERS, 
